    ...
    <section id="team" class="team section-bg">
        <div class="container" data-aos="fade-up">
            ...
            <div class="col-6 m-auto text-center">
                <button type="button" class="btn btn-success btn-sm"> <a href="index.php?hal=form_sperpart">Input</a></button>
                <button type="button" class="btn btn-warning btn-sm"><a href="index.php?hal=form_sperpart">Update</a></button>
                <button type="button" class="btn btn-danger btn-sm">Delete</button>
                <button type="button" class="btn btn-dark btn-sm"><a href="index.php?hal=cobaform">Cancel</a></button>
            </div>
            <div class="row">
